...
async def help_cmd(interaction: discord.Interaction):
    ...
    embed.add_field(name="📢 定期お知らせ", value="`/setup_announcement` - 指定チャンネルに定期メッセージと送信間隔を設定します。\n`/check_announcement` - 現在の設定状況を確認します。", inline=False)
